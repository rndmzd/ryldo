...
import { getProducts, getProductsByCategory, getProductsByCharacter, getCharacters } from '../services/api';
...
const ProductCard = ({ product, onAddToCart }) => {
    ...
    const [selectedColor, setSelectedColor] = useState(
        product.hasVariants && product.variants[0]?.color ? product.variants[0].color : null
    );
        ...
        <Card className="overflow-hidden">
            ...
            <CardContent className="p-4">
                <div className="space-y-1">
                    <CardTitle className="line-clamp-2 min-h-[2rem]">{product.name}</CardTitle>
                    <CardDescription className="line-clamp-2 min-h-[2rem] text-sm text-gray-500">{product.description}</CardDescription>
                </div>
                {product.hasVariants ? (
            ...
            <CardFooter className="p-4">
                <Button
                    ...
                    disabled={product.hasVariants ? !selectedVariant?.inStock : !product.inStock}
                >
                    Add to Cart
                </Button>
            </CardFooter>
    ...
    return (
        <div className="min-h-screen bg-blue-50">
            ...
            <div className="container mx-auto px-4 py-8">
                <h1 className="text-4xl font-bold text-center mb-8">Shop Merchandise</h1>
                ...
                {selectedCharacter && selectedCharacter !== 'stream' && (
                    <CharacterCard character={characters.find(char => char.id === selectedCharacter)} />
                )}
                ...
                {!selectedCharacter && (
                    <div className="text-center mb-8 text-blue-600 text-lg flex items-center justify-center gap-4">
                        ...
                        Select a character tab above to learn more about their story and exclusive merchandise!
                        <ArrowUp className="h-6 w-6 animate-bounce" />
                    </div>
                )}
