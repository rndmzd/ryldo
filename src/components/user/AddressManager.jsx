...
const AddressManager = ({ addresses, onAddressUpdate }) => {
    ...
    const handleBlur = (e) => {
        ...
        const fieldValidation = validateAddress({
            ...formData,
            [name]: value
        });
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className={`mt-1 block w-full border ${validationErrors.street ? 'border-red-300' : 'border-gray-300'
                            ...
                            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        value={formData.city}
                                        onChange={handleChange}
                                        className={`mt-1 block w-full border ${validationErrors.city ? 'border-red-300' : 'border-gray-300'
                                            } rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500`}
                                    />
                                ...
                                <div>
                                    <label htmlFor="state" className="block text-sm font-medium text-gray-700">
                                        {formData.country === 'United Kingdom' ? 'County' :
                                            formData.country === 'United States' ? 'State' :
                                                'Province/Region'}
                                    </label>
                                    <select
                                        name="state"
                                        ...
                                        onChange={handleChange}
                                        className={`mt-1 block w-full border ${validationErrors.state ? 'border-red-300' : 'border-gray-300'
                                            } rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500`}
                                    >
                                        {getStatesByCountry(COUNTRIES.find(c => c.name === formData.country)?.code).map(state => (
                            ...
                            <div>
                                <label htmlFor="zipCode" className="block text-sm font-medium text-gray-700">
                                    {getPostalCodeLabel(COUNTRIES.find(c => c.name === formData.country)?.code)}
                                </label>
                                <input
                                    type="text"
                                    name="zipCode"
                                    ...
                                    onChange={handleChange}
                                    placeholder={getPostalCodePlaceholder(COUNTRIES.find(c => c.name === formData.country)?.code)}
                                    className={`mt-1 block w-full border ${validationErrors.zipCode ? 'border-red-300' : 'border-gray-300'
                                        } rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500`}
                                />
